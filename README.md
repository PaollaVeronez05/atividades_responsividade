...
Este repositório reúne uma série de atividades desenvolvidas com HTML e CSS, focadas na prática de responsividade, grid, flexbox e media queries.
...
🖼️ Foto, nome e descrição pessoal
...
🏷️ Cabeçalho com logotipo e menu

🖼️ Seção principal com título e imagem/banner

ℹ️ Seção de informações (data, local, descrição)
